...
- The belt pours its load off the head in a fan, the front of the heap sloping down to the end and tumbling over, instead of dropping it into the hole in hard vertical sheets (src/scenes.js `beltdrop`).
