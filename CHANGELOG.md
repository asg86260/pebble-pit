...
- The board of times: every rescue's clock on one board for everybody, best first, with your name typed once -- a `times` page on the title screen and on the held sheet, and the post on the ending sheet (test/times.test.mjs, server/test/times.test.ts).
