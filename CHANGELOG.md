...
- A working machine's smoke is the brown puffs off its stack and nothing else; the fringed specks that climbed beside them are gone, and the dirt shows in the clouds (src/scenes.js `farm`).
