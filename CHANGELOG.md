...
- Hovering the air filter's gauge says what it reads in one line: clean, dirty or filthy, how full the sky is, and whether it is getting worse or better (src/selftest/sky.js).
