...
//          swing is a push rather than a stoop. A janitor stands with its feet
//          snapped to a cell and shovels without going anywhere, so a lunge on
//          its y was the only thing about it that moved: a square dropping a
//          whole cell and rising again, four times a second, on the spot --
//          which reads as a bob, not as a stroke. It shoves the shovel out in
...
// How far a lunge throws a body, in cells: a stoop is most of one, a lean is
// half that -- an eighteen-pixel square shoved a whole cell sideways reads as a
// body stepping, not as a body reaching.
const LEAN = 0.5;
