...
function arrive(w) {
  ...
  // a piece of a shield is laid by the body that carried it here, and by
  // nothing else -- and the leg is cleared here because `settle` keeps
  // whatever fields the job's factory does not hand out, and a body still
  // marked 'piece' reads as a builder forever
