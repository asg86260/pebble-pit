...
// `BUILD_GANG` is gone: its cap ("one spare body per build") is written into
// `rebalance` in upgrades.js now, which is the one place that decides who is
// building. See DESIGN.md, "The build yard".
