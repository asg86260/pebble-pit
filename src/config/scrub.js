...
// with the second and third cards. What a fan pulls at each rung, and what
// each rung costs, is a list in config/rungs.js: if the sky comes under control
// too early on a real yard, that is the dial.
