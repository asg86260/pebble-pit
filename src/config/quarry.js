...
// The cut's own stone: the next bench is cut out of the ground the gang is
// already bringing up. A minute or so of a fresh cut.
export const BENCH_SHARDS = 25;     // shards for the first bench
