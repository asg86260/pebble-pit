...
// A shield is tall and what is watched is the rock meeting its top, so the
// pull-in is measured against the thing: the span, the rock over it and a
// little sky fill this much of the frame, never closer than the step above.
