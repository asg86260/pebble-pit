...
// How fast the sphere turns on its upright axis, radians a second, while its
// tender's beam is on it: a slow turn, a whole one in about three quarters of a
// minute. It comes up to that pace and runs down from it over SPHERE_SPIN_EASE
