...
import { BOARD_COLS, CASINO_MARGIN, DECK_H, HOPPER_H, GATE_H, CASINO_SIGN_H, FIELD_H, BIN_H, LABEL_H, TRAY_H } from './casino.js';
...
// pegs, the bins, their pay, and the tray at the foot, with the deck of buttons under the funnel, added up rather than
...
export const CASINO_H = P * (HOPPER_H + GATE_H + DECK_H + CASINO_SIGN_H + FIELD_H + BIN_H + LABEL_H + TRAY_H);
