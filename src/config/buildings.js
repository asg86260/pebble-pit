...
import { BOARD_COLS, BOARD_ROWS, CASINO_SIGN_H, LABEL_H } from './casino.js';
...
// The casino is as wide as its board and as tall as its face: seven slots and
// their walls across, and the sign, the pegs, the slots and the label band
// down. The tray on the roof stands on top of that and is not part of the
// block. See config/casino.js for the parts, and DESIGN.md, "The sand board".
//
// It is the widest thing on the ground, ahead of the school's twenty, which
// suits the one building here that produces nothing.
export const CASINO_W = P * (BOARD_COLS + 2);
export const CASINO_H = P * (CASINO_SIGN_H + BOARD_ROWS + LABEL_H + 1);
