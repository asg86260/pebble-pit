...
import { LADDER,
         ...
         DOSES0, DOSES_CARDS, DOSE_STEP, TIER_BAND, STRENGTH0, STRENGTH5,
...
// Whole doses a rung over its own shorter ladder -- see DOSES0.
export const dosesPer = (lvl = S.dosesLevel) =>
  DOSES0 + DOSE_STEP * Math.max(0, Math.min(DOSES_CARDS * TIER_BAND, lvl | 0));
