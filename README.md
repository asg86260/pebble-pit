...
- Drag to sweep: on the ground it lifts dust off the pile, in the air below the rock it catches pixels still falling. Swinging at the rock never collects its own spray. Flick and let go to throw what you are carrying. Anything past the ledge falls into the pit on the right. The pit is always the same size whatever the window; a bigger window just gets more sky and more ground either side. Scroll with the wheel or arrow keys to see along the pit, shift-wheel or up/down for its depth. Scroll with the wheel or arrow keys, shift-wheel or up/down to look along the pit's depth.
