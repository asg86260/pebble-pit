...
- Drag to sweep: on the ground it lifts dust off the pile, in the air below the rock it catches pixels still falling. Swinging at the rock never collects its own spray. Flick and let go to throw what you are carrying. Anything past the ledge falls into the pit on the right. The scene keeps its proportions at any window size: the ground stretches, the pit deepens, and below a certain size the whole thing scales down rather than rearranging. Scroll with the wheel or arrow keys, shift-wheel or up/down to look along the pit's depth.
