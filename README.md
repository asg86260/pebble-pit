...
- Workers are plain squares: **miners** (hollow centre) orbit the boulder and chip at it, **drillers** (a bite out of one side) park on the thickest rock and bore it out, **workers** (outlined) walk the ground, scoop dust, and toss it off the lip into the pit. Both start slow and carrying one pixel; their upgrades only appear once you own one.
...
- Cores buy the fundamental unlocks, not numbers: **first miner** (1 core, which hires one for you), **first hauler** (2 cores, likewise), and a **wider pick** that breaks several pixels a hit (3 cores, then 6, 9...). Everything else — carry, mining speed, hiring and upgrading workers — is bought with dust.
